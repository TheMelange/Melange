...
Blockchain blockchain = new Blockchain(0, 50);
...
while (true)
{
    ...
    Console.WriteLine("=====================================================");
    Console.WriteLine($"Total Melange generated: {blockchain.GetTotalCoinsInBlockchain().ToString()} of {Blockchain.MAX_COINS}");
